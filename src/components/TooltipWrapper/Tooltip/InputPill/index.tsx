    ...
    switch (e.key) {
      case 'ArrowUp': {
        if (showSuggestedTopics) {
          e.preventDefault();
          console.log('new Index', Math.max(-1, suggestedTopicsIdx - 1))
      ...
      case 'Tab': {
        if (showSuggestedTopics) {
          e.preventDefault();
          console.log('suggestedTopicsIdx', suggestedTopicsIdx)
          const topic = suggestedTopicsIdx === -1 
            ? newTopic 
            : suggestedTopics[suggestedTopicsIdx]
